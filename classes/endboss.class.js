...
class Endboss extends movableObject {
  ...
  /**
   * Animates the movement of the endboss in specific intervals.
   */
  animate() {
    this.animateAlertOrWalk();
    this.animateDeath();
    this.animateAttack();
  }

  /**
   * Handles the alert and walking animation of the endboss.
   */
  animateAlertOrWalk() {
    let i = 0;
    setInterval(() => {
  ...
  /**
   * Handles the death animation of the endboss and triggers the end of the game.
   */
  animateDeath() {
    let i = 0;
    setInterval(() => {
  ...
  /**
   * Handles the attack animation of the endboss when its energy is low.
   */
  animateAttack() {
    setInterval(() => {
      if (this.energy <= 80) {
  ...
  /**
   * Handles the actions after the endboss is defeated.
   */
  handleEndbossDefeat() {
